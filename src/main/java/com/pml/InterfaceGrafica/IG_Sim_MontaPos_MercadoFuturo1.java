...
import com.pml.Simulacoes.Sim_MontaPos_MercFut1;
 ...
 * @author fabra
 */
public class IG_Sim_MontaPos_MercadoFuturo1 extends javax.swing.JFrame {
     ...
     */
    public IG_Sim_MontaPos_MercadoFuturo1() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Monta Pos: Mercado Futuro 1");
        setResizable(false);
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 260, 90, -1));
        ...
        getContentPane().add(jOffsetFin, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 200, 50, -1));
        ...
        getContentPane().add(jPassoOffset, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 200, 50, -1));
        ...
        jOffset.setText("1");
        getContentPane().add(jOffset, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 200, 50, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            IG.configuraGerais();
            IG.setNomeSimulacao("Monta Pos: Mercado Futuro 1");
            configuraEstrategia();
            t1 = new Thread(() -> {
                jButton1.setEnabled(false);
                executaSimulacao();
    ...
    private void executaSimulacao(){
        Sim_MontaPos_MercFut1 simulacao = new Sim_MontaPos_MercFut1(false);
