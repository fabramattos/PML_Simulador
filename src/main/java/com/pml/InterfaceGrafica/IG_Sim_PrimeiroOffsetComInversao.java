...
import com.pml.Simulacoes.Sim_InverteStop1;
 ...
 * @author fabra
 */
public class IG_Sim_PrimeiroOffsetComInversao extends javax.swing.JFrame {
     ...
     */
    public IG_Sim_PrimeiroOffsetComInversao() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("DayTrade: Primeiro Offset Com Inversão");
        setResizable(false);
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, 90, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 250, 90, -1));
        ...
        getContentPane().add(jOffsetFin, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 150, 50, -1));
        ...
        getContentPane().add(jPassoOffset, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 150, 50, -1));
        ...
        getContentPane().add(jOffset, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 150, 50, -1));

        jLabel16.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel16.setText("Loss Fixo");
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 180, -1, -1));
        ...
        jLoss.setText("1");
        getContentPane().add(jLoss, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 180, 50, -1));
        ...
        getContentPane().add(jLossFin, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 180, 50, -1));
        ...
        getContentPane().add(jPassoLoss, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 180, 50, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, 90, -1));
        ...
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, -1, -1));
        ...
        jPos.setText("1");
        getContentPane().add(jPos, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 90, 50, -1));
        ...
        jPosMax.setText("1");
        getContentPane().add(jPosMax, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 120, 50, -1));
        ...
        getContentPane().add(jPosMaxFin, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 120, 50, -1));
        ...
        getContentPane().add(jPassoPos, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 120, 50, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            IG.configuraGerais();
            IG.setNomeSimulacao("Primeiro Offset Com Inversão");
            configuraEstrategia();
            t1 = new Thread(() -> {
                jButton1.setEnabled(false);
                executaSimulacao();
