...
import com.pml.Simulacoes.Sim_MontaPos_DayTrade1;
 ...
 * @author fabra
 */
public class IG_Sim_MontaPos_DayTrade1 extends javax.swing.JFrame {
     ...
     */
    public IG_Sim_MontaPos_DayTrade1() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            IG.configuraGerais();
            IG.setNomeSimulacao("Monta Pos: Day Trade 1");
            configuraEstrategia();
            t1 = new Thread(() -> {
                jButton1.setEnabled(false);
                executaSimulacao();
    ...
    private void executaSimulacao(){
        Sim_MontaPos_DayTrade1 simulacao = new Sim_MontaPos_DayTrade1(false);
