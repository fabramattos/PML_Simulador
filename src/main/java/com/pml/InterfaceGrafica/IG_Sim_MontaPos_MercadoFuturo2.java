...
import com.pml.Simulacoes.Sim_MontaPos_MercFut2;
 ...
 * @author fabra
 */
public class IG_Sim_MontaPos_MercadoFuturo2 extends javax.swing.JFrame {
     ...
     */
    public IG_Sim_MontaPos_MercadoFuturo2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Monta Pos: Mercado Futuro 2");
        setResizable(false);
        ...
        getContentPane().add(jTemContMov, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            IG.configuraGerais();
            IG.setNomeSimulacao("Monta Pos: Mercado Futuro 2");
            configuraEstrategia();
            t1 = new Thread(() -> {
                jButton1.setEnabled(false);
                executaSimulacao();
    ...
    private void executaSimulacao(){
        Sim_MontaPos_MercFut2 simulacao = new Sim_MontaPos_MercFut2(false);
