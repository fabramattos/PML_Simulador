...
import com.pml.Simulacoes.Sim_MontaPos_MaisMenosOCOExtremos;
 ...
 * @author fabra
 */
public class IG_Sim_ReentradasOCO extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("DayTrade: Reentradas OCO");
        setResizable(false);
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 310, 90, -1));
        ...
        jPos.setText("1");
        getContentPane().add(jPos, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 150, 50, -1));
        ...
        jPosMax.setText("1");
        getContentPane().add(jPosMax, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 180, 50, -1));
        ...
        getContentPane().add(jPosMaxFin, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 180, 50, -1));
        ...
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 150, -1, -1));
        ...
        getContentPane().add(jPassoPos, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 180, 50, -1));
        ...
        getContentPane().add(jGainFin, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 210, 50, -1));
        ...
        getContentPane().add(jPassoGain, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 210, 50, -1));
        ...
        getContentPane().add(jGain, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 210, 50, -1));
        ...
        getContentPane().add(jLossFin, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 240, 50, -1));
        ...
        getContentPane().add(jPassoLoss, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 240, 50, -1));
        ...
        getContentPane().add(jLoss, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 240, 50, -1));
        ...
        jTemGain.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTemGainatualizaInterface(evt);
            }
        });
        getContentPane().add(jTemGain, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 210, -1, -1));
        ...
        jTemLoss.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTemLossatualizaInterface(evt);
            }
        });
        getContentPane().add(jTemLoss, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 240, -1, -1));
        ...
        getContentPane().add(jMov, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            IG.configuraGerais();
            IG.setNomeSimulacao("Reentradas OCO");
            configuraEstrategia();
            t1 = new Thread(() -> {
                jButton1.setEnabled(false);
                executaSimulacao();
    ...
    private void jTemGainatualizaInterface(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTemGainatualizaInterface
        verificaConfigRelatorios();
        verificaConfigValores();
        try{
            IG_GerRisco.verificaInterface();
    ...
    }//GEN-LAST:event_jTemGainatualizaInterface

    private void jTemLossatualizaInterface(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTemLossatualizaInterface
        verificaConfigRelatorios();
        verificaConfigValores();
        try{
            IG_GerRisco.verificaInterface();
    ...
    }//GEN-LAST:event_jTemLossatualizaInterface
    ...
    private void verificaConfigValores(){
        verificaDados();
        jGain.setEnabled((jTemGain.isSelected() && jRelatorioCompleto.isSelected()));
        jLoss.setEnabled((jTemLoss.isSelected() && jRelatorioCompleto.isSelected()));
    ...
    private void executaSimulacao(){
        Sim_MontaPos_MaisMenosOCOExtremos simulacao = new Sim_MontaPos_MaisMenosOCOExtremos(false);
