...
import com.pml.Simulacoes.Sim_MontaPos_DayTrade2;
 ...
 * @author fabra
 */
public class IG_Sim_MontaPos_DayTrade2 extends javax.swing.JFrame {
     ...
     */
    public IG_Sim_MontaPos_DayTrade2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Monta Pos: Day Trade 2");
        setResizable(false);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            IG.configuraGerais();
            IG.setNomeSimulacao("Monta Pos: Day Trade 2");
            configuraEstrategia();
            t1 = new Thread(() -> {
                jButton1.setEnabled(false);
                executaSimulacao();
    ...
    private void executaSimulacao(){
        Sim_MontaPos_DayTrade2 simulacao = new Sim_MontaPos_DayTrade2(false);
