...
import com.pml.Simulacoes.Sim_MontaPos_ExtremosCandleAnterior2;

/**
 *
 * @author fabra
 */
public class IG_Sim_MontaPos_ExtremosCandleAnterior2 extends javax.swing.JFrame {
     ...
     */
    public IG_Sim_MontaPos_ExtremosCandleAnterior2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Monta Pos - Extremos Candle Anterior 2");
        setResizable(false);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            IG.configuraGerais();
            IG.setNomeSimulacao("Monta Pos: Extremos Candle Anterior 2");
            configuraEstrategia();
            t1 = new Thread(() -> {
                jButton1.setEnabled(false);
                executaSimulacao();
    ...
    private void executaSimulacao(){
        Sim_MontaPos_ExtremosCandleAnterior2 simulacao = new Sim_MontaPos_ExtremosCandleAnterior2(false);
