 ...
 * @author fabra
 */
public class IG_Sim_MontaPos_MaisMenosOCOExtremos extends javax.swing.JFrame {
     ...
     */
    public IG_Sim_MontaPos_MaisMenosOCOExtremos() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Monta Pos: +/- OCO Extremos");
        setResizable(false);
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 320, 90, -1));
        ...
        getContentPane().add(jGainFin, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 220, 50, -1));
        ...
        getContentPane().add(jPassoGain, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 220, 50, -1));
        ...
        jGain.setText("1");
        getContentPane().add(jGain, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 220, 50, -1));
        ...
        getContentPane().add(jLossFin, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 250, 50, -1));
        ...
        getContentPane().add(jPassoLoss, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 250, 50, -1));
        ...
        jLoss.setText("1");
        getContentPane().add(jLoss, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 250, 50, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 290, 90, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            IG.configuraGerais();
            IG.setNomeSimulacao("Monta Pos: +/- OCO Extremos");
            configuraEstrategia();
            t1 = new Thread(() -> {
                jButton1.setEnabled(false);
                executaSimulacao();
