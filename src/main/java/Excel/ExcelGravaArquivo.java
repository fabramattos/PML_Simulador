...
public class ExcelGravaArquivo implements AcoesExcel{
    ...
    private String escolheDestino() {
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            InterfaceGrafica.IG.textoAdd("Salvando arquivo em: " + selectedFile.getAbsolutePath() + "\n");
    ...
    public void executa(SXSSFWorkbook workbookGravacao) {
        ...
        try{
            ...
            e.printStackTrace();
            InterfaceGrafica.IG.textoAdd("Arquivo Excel não encontrado! \n");
        } catch (IOException e) {
            e.printStackTrace();
            InterfaceGrafica.IG.textoAdd("Erro na edição do arquivo!");
